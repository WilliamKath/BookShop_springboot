...
@ServerEndpoint(value = "/webSocket/{username}/{sellername}")
@Component
public class WebSocketServer {
    ...
    @Autowired
    private void setWebMsgService(MsgService msgService){
...
*/
     ...
     */
    @OnOpen
    public void onOpen(Session session, @PathParam("username") String username, @PathParam("sellername") String sellername) {
...
//        {"users": [{"username": "zhang"},{ "username": "admin"}]}
        ...
        List<Msg> msgListToAndFrom = msgService.GetMsgService(sellername,username);
